...
class MR_PLAY_MUSIC(mr_base):
    def __init__(self):
        mt_type = [
                    {'key':'NONE',    'type':'s',  'mt':r'^.*<SRC:MUSIC_8.2.0.0_BCS29.*'},
                    {'key':'NA',    'type':'s',    'mt':r'NA:'+common_def.MT_VALUE_VALID_POSTFIX},
                    {'key': 'AR', 'type': 's', 'mt': r'AR:' + common_def.MT_VALUE_INVALID_POSTFIX},
                    {'key': 'F', 'type': 's', 'mt': r'F:' + common_def.MT_VALUE_INVALID_POSTFIX},
                    {'key': 'RID', 'type': 's', 'mt': r'RID:' + common_def.MT_VALUE_INVALID_POSTFIX},
                    {'key': 'BLKCNT', 'type': 'i', 'mt': r'BLKCNT:' + common_def.MT_VALUE_INVALID_POSTFIX},
    ...
    def InitReducer(self, value):
        try:
            common_util.X_InitReducer(value+"BLKCNT", self.mt_type)
