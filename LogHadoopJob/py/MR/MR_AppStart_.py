...
class MR_APPSTART(mr_base_ex):
    def __init__(self):
        ...
        self.res_type = ["s","s","s","s","s","s","i","i","i","i","i"];
        self.res_name = ["SRC","Type","STARTSRC","UUID","UMAC","SKINTYPE","SKINID","SONGWP","STARTPAGEWP","U",];#{'SRC':'','Type','','U':""};
